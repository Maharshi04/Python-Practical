...
# github repository link : https://github.com/Maharshi04/Python-Practical/blob/main/Pract9.py
...
class Exam(Student):
    ...
    def init(self, name, age, gender, sub_length):
    ...
    # allowing the user to change the subjects...
